...
public class CreatureWorld extends World
{
    ...
    public void act()
    {
        ...
        if(turnNumber == 0)
        {
            ...
            oneFightMenu = (new Menu(" Fight ", " Scratch \n Falmethrower ", 24, greenfoot.Color.BLACK, greenfoot.Color.WHITE, greenfoot.Color.BLACK, greenfoot.Color.WHITE, new FightCommands()));
            ...
            playerOneName = JOptionPane.showInputDialog(null, "create a player name","player one entry",JOptionPane.QUESTION_MESSAGE);
            ...
            playerTwoName = JOptionPane.showInputDialog(null, "create a player name","player one entry",JOptionPane.QUESTION_MESSAGE);
        }
        ...
        else if(turnNumber == 1)
        {
            ...
            showText( playerOneName + ", it is your turn ",getWidth()/2,getHeight()/2);
        }
    ...
    /**
     *getTurnNumber returns the turn number to use in other parts of code
     *
     * @param There are no parameters         
     * @return Returns an integer
     */

    //TODO (26): Declare a public method called getTurnNumber that returns an integer and has no parameters
    ...
    /**
     * setTurnNumber makes it so they have turns between pikachu 
     * and charmander
     * 
     * @param There is a parameter called turn          
     * @return There is nothing being returned
     */
    //TODO (28): Declare a public method called setTurnNumber that does not return anything and has an integer parameter called turn
