...
public class Creature extends Actor
{
    ...
    /**
     * 
     * @param There is an int parameter called idx         
     * @return Nothing is returned
     */
    //TODO (50): Declare a public method called attack that does not return anything and has an integer parameter called idx
    public void attack(int idx)
    {
        //TODO (51): Inside the method, put a comment stating that attack is an "empty method that will get overridden in subclasses
        //empty method that will get overridden in subclasses
    }
     ...
     */
    //TODO (52): Declare a protected method called getType that returns a String and has no parameters
